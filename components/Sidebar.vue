<template>
  <nav>
    ...
    <aside
      ref="sidebarRef"
      v-show="menuOpen"
      class="transform top-0 left-0 w-64 bg-green-400 fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30"
    ...
    >
      ...
      <div v-if="auth.isAuthenticated">
        ...
        >
          ...
          <NuxtLink to="/adminAccount">Admin</NuxtLink>
      ...
      <div v-else>
        ...
        >
          ...
          <NuxtLink to="/login">Feed</NuxtLink>
        </span>
      </div>
      ...
      <span class="flex items-center p-4 hover:bg-indigo-500 hover:text-white">
        ...
        <NuxtLink to="/newTransport"> NewTransport </NuxtLink>
      </span>
      ...
      <span class="flex items-center p-4 hover:bg-indigo-500 hover:text-white">
        ...
        <NuxtLink to="/myTransport">MyTransport</NuxtLink>
      </span>
      <span class="flex items-center p-4 hover:bg-indigo-500 hover:text-white">
        <span class="mr-2">
          <svg
        ...
        <NuxtLink to="/arrival">Arrival</NuxtLink>
      </span>
      ...
      <div class="fixed bottom-0 w-full">
        ...
        >
          ...
          <p>
            <span class="font-bold">OpenLogger</span>
            <br />
            <span class="text-sm text-white">Your things online</span>
          </p>
        </a>
      </div>
    </aside>
